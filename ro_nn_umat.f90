...
DOUBLE PRECISION, DIMENSION(NTENS) :: STRESS, STATEV, DDSDDT, DRPLDE, STRAN, DSTRAN, RPL
DOUBLE PRECISION, DIMENSION(NTENS, NTENS) :: DDSDDE
DOUBLE PRECISION :: SSE, SPD, SCD, DRPLDT
DOUBLE PRECISION, DIMENSION(2) :: TIME
DOUBLE PRECISION, DIMENSION(*) :: PREDEF, DPRED
DOUBLE PRECISION, DIMENSION(NPROPS) :: PROPS
DOUBLE PRECISION, DIMENSION(3) :: COORDS
DOUBLE PRECISION, DIMENSION(3,3) :: DROT, DFGRD0, DFGRD1
DOUBLE PRECISION :: E, NU, LAMBDA, MU, MAX_STRESS, CESTRN
